...
const Page2 = () => {
  return (
    <>
      ...
      >
        <div className="u-clearfix u-layout-wrap u-layout-wrap-1">
          <div className="u-layout">
            <div className="u-layout-row" style={{ flexWrap: 'unset' }}>
              <div
                className="
                u-align-left
                u-container-style
              ...
              >
                ...
                >
                  ...
                  <p className="u-text u-text-3">
                    We will help you to feel better and enjoy every single day of
                    your life.
                  </p>
                  <a
              ...
              >
                <div className="u-container-layout u-valign-bottom"></div>
              </div>
            </div>
          </div>
        </div>
      </section>
      <section className="u-clearfix u-section-2" id="sec-e779">
        <div className="u-clearfix u-sheet u-sheet-1">
          <div className="u-list u-list-1">
            <div className="u-repeater u-repeater-1">
              ...
              >
                ...
                >
                  <span
                    className="u-icon u-icon-circle u-text-palette-1-base u-icon-3"
                  ><svg
                    className="u-svg-link"
                    preserveAspectRatio="xMidYMin slice"
                    viewBox="0 0 64 64"
                  ...
                  >
                    ...
                    >
                      ...
                      ></path>
                      <path
                        d="m39 42c6.617 0 12-5.383 12-12s-5.383-12-12-12-12 5.383-12 12 5.383 12 12 12zm0-22c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10z"
                      ></path>
                      <path
                        d="m33 33h3v3c0 .553.448 1 1 1h4c.552 0 1-.447 1-1v-3h3c.552 0 1-.447 1-1v-4c0-.553-.448-1-1-1h-3v-3c0-.553-.448-1-1-1h-4c-.552 0-1 .447-1 1v3h-3c-.552 0-1 .447-1 1v4c0 .553.448 1 1 1zm1-4h3c.552 0 1-.447 1-1v-3h2v3c0 .553.448 1 1 1h3v2h-3c-.552 0-1 .447-1 1v3h-2v-3c0-.553-.448-1-1-1h-3z"
                      ></path></svg
                    ></span>
                  <h3
              ...
              >
                ...
                >
                  <span
                    className="u-icon u-icon-circle u-text-palette-1-base u-icon-4"
                  ><svg
                    className="u-svg-link"
                    preserveAspectRatio="xMidYMin slice"
                    viewBox="0 0 511.998 511.998"
                  ...
                  >
                    ...
                    >
                      ...
                      <g>
                        <g>
                          <path
                            d="M117.023,365.203l-0.287-0.257c-4.109-3.69-10.432-3.35-14.122,0.759c-3.69,4.109-3.35,10.432,0.759,14.122l0.287,0.257    c1.91,1.715,4.298,2.56,6.678,2.56c2.74,0,5.469-1.12,7.444-3.319C121.472,375.214,121.132,368.893,117.023,365.203z"
                          ></path>
                        </g>
                      </g>
                      <g>
                      ...
                      <g>
                        <g>
                          <path
                            d="M359.514,80.002c-5.523,0-10.001,4.477-10.001,10s4.477,10,10,10h0.055c5.523,0,9.973-4.477,9.973-10    S365.037,80.002,359.514,80.002z"
                          ></path>
                        </g>
                      </g>
                      <g>
                        <g>
                          <path
                            d="M446.361,126.157c-12.368-17.978-29.495-31.549-49.531-39.249c-5.155-1.981-10.94,0.592-12.922,5.747    c-1.981,5.155,0.592,10.94,5.747,12.922c33.496,12.872,56.002,46.243,56.002,83.039c0,5.523,4.477,10,10,10s10-4.477,10-10    C465.657,166.103,458.985,144.505,446.361,126.157z"
                          ></path>
                        </g>
                      </g></svg
                    ></span>
              ...
              >
                ...
                >
                  <span
                    className="u-icon u-icon-circle u-text-palette-1-base u-icon-5"
                  >
                    <svg
                      className="u-svg-link"
                      preserveAspectRatio="xMidYMin slice"
              ...
              >
                ...
                >
                  <span
                    className="u-icon u-icon-circle u-text-palette-1-base u-icon-6"
                  ><svg
                    className="u-svg-link"
                    preserveAspectRatio="xMidYMin slice"
                    viewBox="0 0 512 512"
          ...
          >
            <div className="u-container-layout u-valign-middle u-container-layout-7">
              ...
              <h2 className="u-custom-font u-font-playfair-display u-text u-text-14">
                Weekly Timetable
              </h2>
              <p className="u-text u-text-15">
                You can make an appointment , select the convient time and choose
                the appropriate doctor here.
              </p>
              <a
                ...
                >
                  ...
                  >
                    ...
                    <p className="u-text u-text-3">
                      ...
                      help. <br />
                      <br />Clinical excellence, diversity, and access to
                      innovative technology are all hallmarks of the graduate
                      medical education experience at Caring Doc. Our residents,
                      fellows, and renowned staff share their experience working
                      at Caring Doc. <br />
                      <br /><b
                      >We try to do our best to help you and provide with a
                        high-quality services.</b
                      >
                    </p>
                    <a
      ...
      <section
        className="u-clearfix u-valign-middle u-white u-section-4"
        id="carousel_b096"
      >
        <div className="u-clearfix u-layout-wrap u-layout-wrap-1">
          <div className="u-layout">
              ...
              >
                ...
                >
                  ...
                  <p className="u-text u-text-2">
                    In most cases, the initial consultation will be sufficient. In
                    more complicated cases, a second, follow-up consultation may
                    be necessary. You can contact our center at any time and ask
                    your questions. Our professional support representative will
                    answer your questions with great pleasure.&nbsp;<br />
                  </p>
                  <h6
                    className="u-custom-font u-font-playfair-display u-text u-text-3"
                  >
                    Take the First Step to Help&nbsp;<br />
      ...
      <section
        className="u-align-center u-clearfix u-custom-typography u-section-5"
        id="carousel_a89f"
      >
        <div className="u-clearfix u-sheet u-sheet-1">
              ...
              <div className="u-layout-row">
                ...
                >
                  ...
                  >
                    ...
                    <p className="u-align-center u-text u-text-grey-50 u-text-3">
                ...
                >
                  ...
                  >
                    ...
                    <p className="u-align-center u-text u-text-grey-50 u-text-5">
                      Restorative Dentist
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    <p className="u-align-center u-text u-text-grey-50 u-text-7">
